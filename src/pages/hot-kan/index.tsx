    ...
    <div>
      <div className="flex flex-row justify-center gap-2 px-2 py-4 bg-black tracking-widest">
        ...
        <div className="flex items-center self-center gap-2 px-2 py-4 bg-black tracking-widest">
          <a href="" className="text-yellow-200 text-sm place-content-center">
            HOME
          </a>
          ...
          <a href="" className="text-white text-sm place-content-center">
            求人情報
          </a>
          <a href="" className="text-white text-sm place-content-center">
            よくあるご質問
        ...
        <div className="flex flex-row flex-nowrap mx-12 w-[1000px] gap-[20px]">
          <div className="flex flex-col flex-shrink w-[350px] h-fit">
            ...
            <div className="flex flex-col items-left bg-white p-5 gap-3 ">
              <div className="text-[20px] font-bold">介護サービス情報公表</div>
              <a
                className="inline-block bg-[#17A2B8] text-white text-[12px] w-fit text-center px-4 py-2
              rounded"
                href=""
                target="_blank"
                rel="noopener"
          ...
          <div className="flex flex-col flex-shrink w-[350px] h-fit bg-white">
            ...
            <div className="flex flex-col bg-white gap-4 p-5">
              ...
              <div className="bg-red-600 text-white text-[10px] w-fit px-1 py-[2px] rounded ml-1">
                2021.4月new
              </div>
          ...
          <div className="flex flex-col flex-shrink w-[350px] h-fit bg-white">
            ...
            <div className="flex flex-col bg-white px-5">
              <div className="bg-blue-400 text-center w-[200px] h-[100px]">
                facebook
              </div>
            </div>
            <div className="flex flex-col bg-white p-5">
              <div className="bg-blue-200 text-center w-[200px] h-[400px]">
                SNS
              </div>
            </div>
            <div className="flex flex-col bg-white p-5 gap-4">
              ...
              <div className="bg-purple-400 text-center w-[200px] h-[200px]">
                instagram
              </div>
              <a
                className="bg-orange-600 text-white text-[12px] w-fit px-4 py-2 rounded"
            ...
            <div className="flex flex-col bg-white p-5 gap-4">
              ...
              <div className="text-sm">
                私たちは「Respect The Law 38 プロジェクト」に賛同しています。
              </div>
            </div>
          </div>
        </div>
